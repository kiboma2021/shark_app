...
class SharksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shark" do
    assert_difference("Shark.count") do
      post sharks_url, params: { shark: { description: @shark.description, name: @shark.name } }
    end
  ...
  test "should update shark" do
    patch shark_url(@shark), params: { shark: { description: @shark.description, name: @shark.name } }
